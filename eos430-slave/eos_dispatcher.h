...
// define this callback to be notified the moment a message is complete
// this is called from the ISR, so keep it short
extern void eos_message_complete_callback();
